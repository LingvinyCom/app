    ...
    return (
      <View style={styles.mainContainer}>
        ...
        <MainDropdownMenu
          ...
          showDropDownMoveTo={ () => this.setState({isMoveToDropdownVisible: true, isMainDropdownVisible: false})}
          hideDropdown={() => this.setState({isMainDropdownVisible: false})}
        />
        <MoveToDropdown
          ...
          hideDropdown={() => this.setState({isMoveToDropdownVisible: false, isMainDropdownVisible: false})}
        />
      </View>
    );
  }
